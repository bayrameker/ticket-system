...
{
    if($db->update('admin',['is_deleted'=>1],['id'=>$_GET['delete']]))
    {
        $_SESSION['toast'] = "Kullanıcı Silindi.";
    }
...
<head>
      ...
      <header class="header header-inverse">
        <div class="container">
          <div class="header-info">
            <div class="left">
              <br>
              <h2 class="header-title"><strong>Kullanıcılar</strong> <small class="subtitle">Kategori kısmından seçtiğiniz departman için kullanıcıları görüntüleyin ve düzenleyin. </small></h2>
            </div>
          </div>

          <div class="header-action">
            <nav class="nav">
              <a class="nav-link active" href="user-list.php">Kullanıcılar</a>
                <?php 
                if(isset($_SESSION['user']))
                {
                ?>
              <a class="nav-link" href="user-add.php">Yeni Ekle</a>
                <?php
                }
                    ?>
            </nav>
 <?php 
                ...
                ?>
            <div class="buttons">
              <a class="btn btn-primary btn-float" href="user-add.php" title="Yeni Yazı Ekle" data-provide="tooltip"><i class="ti-plus"></i></a>
            </div>
              <?php
                }
                    ?>
            ...
            <div class="col-md-4 col-xl-3">
                ...
                <form class="card-body" method="post">
                  ...
                  <div class="text-right">
                    <a class="btn btn-sm btn-bold btn-secondary mr-1" href="user-list.php">sıfırla</a>
...
<?php
                  ...
                  <div class="media align-items-center">
                    ...
                    <a class="media-action hover-primary" href="user-add.php?update=<?php echo $row->id; ?>" data-provide="tooltip" title="Edit"><i class="ti-pencil"></i></a>
                    <a class="media-action hover-danger" onclick="return confirm('Are you sure ?');" href="user-list.php?delete=<?php echo $row->id; ?>" data-provide="tooltip" title="Delete" data-perform="delete-single" data-target=""><i class="ti-close"></i></a>
                  </div>
<?php
                        }
                    }
